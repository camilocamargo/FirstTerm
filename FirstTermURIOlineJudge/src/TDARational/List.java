...
//        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(System.out));
//        Node temp = head;
//        while (!String.valueOf(temp.Node.this.number).equals(number) && temp.next != null) {
//            temp = temp.next;
//        }
//        if (String.valueOf(temp.Node.this.number).equals(number)) {
//            bw.write("Number: " + temp.Node.this.number+ "\n");
//            bw.flush();
//        } else {
...
//    }
    ...
    public void quickSort() {
        if (!isEmpty()) {
            ...
            while (temp != null) {
                if (temp.character < pivot.character) {
...
//                temp = temp.next;
//            }
//            if(temp.Node.this.number == number){
//                return temp;
//            }
//            else if(number > temp.Node.this.number){
//                lower = middle;
//            }else{
//                higher = middle;
//                temp = head;
